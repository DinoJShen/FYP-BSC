    ...
    <div class="row">
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    <form method="post" action="/quiz" autocomplete="off">
                        ...
                        <div class="form-group{{ $errors->has('lvl') ? ' has-danger' : '' }}">
                            <label class="form-control-label" for="input-admin">{{ __('Level') }}</label>
                            <select name="level" id="lvl" class="form-control"  required>
                        ...
                        <div class="form-group{{ $errors->has('question') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="question" id="input-name" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Question') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('option1') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="option1" id="input-name" class="form-control form-control-alternative{{ $errors->has('option') ? ' is-invalid' : '' }}" placeholder="{{ __('Option 1') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option2') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="option2" id="input-name" class="form-control form-control-alternative{{ $errors->has('option') ? ' is-invalid' : '' }}" placeholder="{{ __('Option 2') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option3') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="option3" id="input-name" class="form-control form-control-alternative{{ $errors->has('option') ? ' is-invalid' : '' }}" placeholder="{{ __('Option 3') }}" required>
                        ...
                        <div class="form-group{{ $errors->has('option4') ? ' has-danger' : '' }}">
                            ...
                            <input type="text" name="option4" id="input-name" class="form-control form-control-alternative{{ $errors->has('option') ? ' is-invalid' : '' }}" placeholder="{{ __('Option 4') }}" required>
